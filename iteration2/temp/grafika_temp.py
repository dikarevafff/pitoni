...
def start_the_calculation(dict1, dict2):
    ...
    for i in range(4):
        ax.text(i + 1 - width + 0.08 , -max_value*0.08, 'Л', ha='center', va='top', fontsize=8)  # Л для левой руки
        ax.text(i + 1 + width * 1.5 + 0.009, -max_value*0.08, 'П', ha='center', va='top', fontsize=8)  # П для правой руки
